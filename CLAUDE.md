...
- State lives in `progress/HANDOFF.md`. Plans live in `progress/M*.md`.
  ...
  protocol is `docs/relay.md`.
- Never read a whole crate or document to orient. Read `HANDOFF.md`, then
  grep and read by section as questions arise.
- Never reopen a decision listed as frozen in `HANDOFF.md` without the
  user asking for it.
- No comments in code, no emojis anywhere, no AI attribution in git.
